package com.vs.test.step_definitions.gui.register;


import com.vs.test.enums.PermittedCharacters;
import com.vs.test.framework.helpers.utils.RandomGenerator;
import com.vs.test.page_objects.gui.NewRegistrationPage;
